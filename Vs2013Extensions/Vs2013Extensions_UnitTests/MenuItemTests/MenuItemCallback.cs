...
namespace Vs2013Extensions_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		public void InitializeMenuCommand()
		{
			...
			CommandID menuCommandID = new CommandID(ErR.Vs2013Extensions.GuidList.guidVs2013ExtensionsCmdSet, (int)ErR.Vs2013Extensions.PkgCmdIDList.cmdidErrExtensions);
