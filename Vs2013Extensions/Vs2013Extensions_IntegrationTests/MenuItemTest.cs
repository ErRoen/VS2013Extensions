...
namespace Vs2013Extensions_IntegrationTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		public void LaunchCommand()
		{
			...
			{
				CommandID menuItemCmd = new CommandID(ErR.Vs2013Extensions.GuidList.guidVs2013ExtensionsCmdSet, (int)ErR.Vs2013Extensions.PkgCmdIDList.cmdidErrExtensions);

				// Create the DialogBoxListener Thread.
				string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Vs2013Extensions", "ErR.Vs2013Extensions.Vs2013ExtensionsPackage");
